...
const CANVAS_VIEWS = new Set(['mindmap', 'knowledgeGraph', 'outline', 'executive', 'tasks', 'kanban', 'table']);
const STRUCTURED_CANVAS_VIEWS = new Set(['outline', 'executive', 'tasks', 'kanban', 'table']);
