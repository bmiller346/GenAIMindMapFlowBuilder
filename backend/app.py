...
from routers.ai_drafts import create_ai_draft_router, react_node_from_graph_node as _react_node_from_graph_node
from routers.workspace_exports import create_workspace_export_router
...
app.include_router(
    create_workspace_export_router(
        get_workspace_graph_or_404=get_workspace_graph_or_404,
        get_workspace_branch_or_404=get_workspace_branch_or_404,
        get_upload_flow_or_400=get_upload_flow_or_400,
        list_ai_draft_sessions_for_workspace=list_ai_draft_sessions_for_workspace,
        prepare_source_set_uploads=prepare_source_set_uploads,
        ingestion_http_error=ingestion_http_error,
        source_set_component_metadata=source_set_component_metadata,
        uploaded_source_payload=uploaded_source_payload,
        get_source_components=get_source_components,
        component_collection=component_collection,
        generate_source_reconciliation_preview=generate_source_reconciliation_preview,
    )
)
app.include_router(
    create_ai_draft_router(
        get_workspace_graph_or_404=get_workspace_graph_or_404,
        get_workspace_flow_or_404=get_workspace_flow_or_404,
        get_source_components=get_source_components,
        save_ai_draft_session=save_ai_draft_session,
        get_ai_draft_session_or_404=get_ai_draft_session_or_404,
        list_ai_draft_sessions_for_workspace=list_ai_draft_sessions_for_workspace,
        persist_flow_snapshot=_persist_flow_snapshot,
        query_with_workspace_brief=query_with_workspace_brief,
        query_with_follow_up_memory=query_with_follow_up_memory,
    )
)
