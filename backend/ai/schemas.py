...
EVIDENCE_REPAIR_TARGET_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": ["string", "null"]},
        ...
        "represented_row_indexes": {"type": "array", "items": {"type": "integer"}},
...
SOURCE_REPAIR_OUTPUT_SCHEMA: dict[str, Any] = {
    "type": ["object", "null"],
    "additionalProperties": False,
    "properties": {
        "summary": {"type": ["string", "null"]},
        "rows": {"type": "array", "items": EVIDENCE_REPAIR_TARGET_SCHEMA},
        "paths": {"type": "array", "items": EVIDENCE_REPAIR_TARGET_SCHEMA},
        "edges": {"type": "array", "items": EVIDENCE_REPAIR_TARGET_SCHEMA},
        "findings": {"type": "array", "items": EVIDENCE_REPAIR_TARGET_SCHEMA},
        "tasks": {"type": "array", "items": EVIDENCE_REPAIR_TARGET_SCHEMA},
        "source_refs": {"type": "array", "items": SOURCE_REF_OUTPUT_SCHEMA},
        "assumptions": {"type": "array", "items": {"type": "string"}},
    },
    "required": [
...
CONNECTED_PICTURE_PACKAGE_REVIEW_ITEM_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
        ...
        "review_state": {"type": ["string", "null"]},
        "needs_review": {"type": "boolean"},
        "required_sibling_ids": {"type": "array", "items": {"type": "string"}},
        "dependency_link_ids": {"type": "array", "items": {"type": "string"}},
        "source_refs": {"type": "array", "items": SOURCE_REF_OUTPUT_SCHEMA},
        "assumptions": {"type": "array", "items": {"type": "string"}},
        "metadata": METADATA_OUTPUT_SCHEMA,
    },
...
CONNECTED_PICTURE_PACKAGE_PRIMARY_NODE_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_RELATIONSHIP_EDGE_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
        ...
        "source_node_id": {"type": "string"},
        "target_node_id": {"type": "string"},
        "source_package_item_id": {"type": "string"},
        "target_package_item_id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_VIEW_LENS_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_STRUCTURED_EVIDENCE_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_EVIDENCE_LINK_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
        ...
        "target_type": {
            "type": "string",
            "enum": ["primary_node", "relationship_edge", "task", "risk", "decision", "repair_target"],
        },
...
CONNECTED_PICTURE_PACKAGE_REPAIR_TARGET_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_ACCEPTANCE_GROUP_SCHEMA: dict[str, Any] = {
    "type": "object",
    "additionalProperties": False,
    "properties": {
        "id": {"type": "string"},
...
CONNECTED_PICTURE_PACKAGE_OUTPUT_SCHEMA: dict[str, Any] = {
    "type": ["object", "null"],
    "additionalProperties": False,
    "properties": {
        "package_id": {"type": "string"},
        "primary_nodes": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_PRIMARY_NODE_SCHEMA,
        },
        "relationship_edges": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_RELATIONSHIP_EDGE_SCHEMA,
        },
        "view_lenses": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_VIEW_LENS_SCHEMA,
        },
        "structured_evidence": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_STRUCTURED_EVIDENCE_SCHEMA,
        },
        "evidence_links": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_EVIDENCE_LINK_SCHEMA,
        },
        "tasks": {"type": "array", "items": CONNECTED_PICTURE_PACKAGE_REVIEW_ITEM_SCHEMA},
        "risks": {"type": "array", "items": CONNECTED_PICTURE_PACKAGE_REVIEW_ITEM_SCHEMA},
        "decisions": {"type": "array", "items": CONNECTED_PICTURE_PACKAGE_REVIEW_ITEM_SCHEMA},
        "repair_targets": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_REPAIR_TARGET_SCHEMA,
        },
        "source_refs": {"type": "array", "items": SOURCE_REF_OUTPUT_SCHEMA},
        "assumptions": {"type": "array", "items": {"type": "string"}},
        "acceptance_groups": {
            "type": "array",
            "items": CONNECTED_PICTURE_PACKAGE_ACCEPTANCE_GROUP_SCHEMA,
        },
    },
    "required": [
        "package_id",
...
ARTIFACT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "connected_picture_package": _artifact_definition(
        "connected_picture_package",
        requires=["accepted_nodes"],
        optional=[
            "relationship_edges",
        ...
        generated_schema={
            ...
            "primary_nodes": "source-backed or review-marked nodes in the connected picture",
            "relationship_edges": "typed edges connecting primary nodes",
            "view_lenses": "reviewable map, flow, evidence, risk, or decision lenses",
            "structured_evidence": "evidence rows supporting nodes, edges, tasks, risks, and decisions",
            "evidence_links": "links from structured evidence to package items",
            "tasks": "reviewable task candidates",
            "risks": "reviewable risk findings",
            "decisions": "reviewable decision points",
            "repair_targets": "invalid, unsupported, or incomplete refs needing repair",
            "source_refs": "source refs copied from allowed source context",
            "assumptions": "unsupported package-level assumptions",
            "acceptance_groups": "groups of package items for preview acceptance",
        },
        projection_requirements=[
            "primary nodes exist",
            "relationships, evidence links, and acceptance groups reference package item ids",
            "unsupported or unresolved items are marked needs_review with assumptions",
        ],
        supported_views=["map", "knowledge_graph", "review", "tasks", "source_evidence"],
        preview_component="ConnectedPicturePackagePreview",
        accept_behavior="attach_connected_package_after_preview_acceptance",
        export_behavior="markdown_package, graph_json, evidence_report",
        validation_rules=[
            "package_has_primary_nodes",
            "refs_resolve_to_package_items",
            "invalid_refs_create_repair_targets",
            "unsupported_items_marked_needs_review",
        ],
    ),
...
AI_DRAFT_REVISION_OUTPUT_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "source_repair": SOURCE_REPAIR_OUTPUT_SCHEMA,
        ...
        "connected_picture_package": CONNECTED_PICTURE_PACKAGE_OUTPUT_SCHEMA,
