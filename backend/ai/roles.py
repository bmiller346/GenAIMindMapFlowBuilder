...
PROMPT_PROFILE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "standards_completeness_reviewer": {
        "role_id": "standards_completeness_reviewer",
        "label": "Standards Completeness Reviewer",
        "group": "TraceSpace",
        "description": "Reviews grouped standards and technical source sets for missing, weak, stale, or contradictory guidance.",
        "supported_scopes": ["node", "branch", "workspace"],
        "supported_actions": [
            "assess_standards_completeness",
            "find_missing_source_support",
        ...
        "system_instructions": "Compare source-backed standards coverage against the requested domain. Identify documented, partially documented, missing, conflicting, stale, and needs_review areas without inventing citations.",
        "default_output_shape": "missing_info_report",
        "source_strictness": "strict",
        "default_review_status": "needs_review_when_unsourced",
    },
    "roadmap_planner": {
        "role_id": "roadmap_planner",
        "label": "Roadmap Planner",
        "group": "TraceSpace",
        "description": "Turns complex source material into a team-facing roadmap, milestones, decisions, and next actions.",
        "supported_scopes": ["branch", "workspace"],
        "supported_actions": [
            "create_team_roadmap",
            "generate_tasks",
            "generate_checklist",
    ...
    "enterprise_process_analyst": {
        "role_id": "enterprise_process_analyst",
        "label": "Enterprise Process Analyst",
        "group": "TraceSpace Enterprise",
        "description": "Finds process bottlenecks, handoff friction, unclear ownership, and operational readiness gaps.",
        "supported_scopes": ["branch", "workspace"],
        "supported_actions": [
        ...
        "system_instructions": "Create source-aware enterprise process findings with symptoms, impacted teams, owner gaps, and reviewable next actions.",
        "default_output_shape": "review_annotations",
        "source_strictness": "prefer_source_refs",
        "default_review_status": "needs_review_when_unsourced",
    },
    "enterprise_tool_rationalization": {
        "role_id": "enterprise_tool_rationalization",
        "label": "Enterprise Tool Rationalization",
        "group": "TraceSpace Enterprise",
        "description": "Finds duplicate tools, overlapping capabilities, unsupported business-critical systems, and integration coverage gaps.",
        "supported_scopes": ["branch", "workspace"],
        "supported_actions": [
        ...
        "system_instructions": "Compare tools and systems by purpose, owner, criticality, evidence, support model, and integration dependency before recommending consolidation.",
        "default_output_shape": "review_annotations",
        "source_strictness": "strict",
        "default_review_status": "needs_review_when_unsourced",
    },
    "enterprise_readiness_planner": {
        "role_id": "enterprise_readiness_planner",
        "label": "Enterprise Readiness Planner",
        "group": "TraceSpace Enterprise",
        "description": "Creates phased improvement plans and stakeholder review packages from enterprise readiness findings.",
        "supported_scopes": ["branch", "workspace"],
        "supported_actions": [
    ...
    "enterprise_business_architect": {
        "role_id": "enterprise_business_architect",
        "label": "Enterprise Business Architect",
        "group": "TraceSpace",
        "description": "Maps business units, capabilities, processes, systems, risks, controls, ownership, costs, dependencies, and decisions using the enterprise business ontology.",
        "supported_scopes": ["node", "branch", "workspace"],
        "supported_actions": [
            "expand_this_node",
            "generate_child_nodes",
        ...
        "system_instructions": "Use the TraceSpace enterprise business ontology for node_type and relationship_type values. Keep inferred business relationships source-backed or marked needs_review.",
