...
- Review semantic knowledge graph relationships separately from hierarchy, with
  relationship-family grouping and Markdown review exports.
...
TraceSpace's product lanes are documented in
...
intelligence, knowledge graph relationship review, Sankey flow lenses,
workspace shell/ribbon layout, and Miro/monday handoff all have product guides
so future work keeps the same source-grounded, review-first intent.
